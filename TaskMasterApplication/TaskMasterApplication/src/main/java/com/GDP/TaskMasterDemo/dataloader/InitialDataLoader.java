package com.GDP.TaskMasterDemo.dataloader;
...
import com.GDP.TaskMasterDemo.Services.RoleService;
...
//        //ROLES --------------------------------------------------------------------------------------------------------
//        if(!allRoles.contains(new Role("ADMIN"))) {
//        	roleService.createRole(new Role("ADMIN"));
//        }
//        if(!allRoles.contains(new Role("USER"))){
...
//                today.minusDays(40),today.minusDays(50),
//                true,
//                userService.getUserByEmail("laxmi@mail.com").getName(),
//                userService.getUserByEmail("laxmi@mail.com"),"HIGH"
//        ));
//
//        //2
//        taskService.createTask(new Task(
...
//                today.minusDays(30),today.minusDays(32),
//                true,
//                userService.getUserByEmail("teja@mail.com").getName(),
//                userService.getUserByEmail("teja@mail.com"),"MEDIUM"
//        ));
//
//        //3
//        taskService.createTask(new Task(
...
//                today.minusDays(20),today.minusDays(21),
//                true,
//                userService.getUserByEmail("vaishu@mail.com").getName(),
//                userService.getUserByEmail("vaishu@mail.com"),"LOW"
//        ));
//
//        //4
//        taskService.createTask(new Task(
...
//                true,
//                userService.getUserByEmail("chaithu@mail.com").getName(),
//                userService.getUserByEmail("chaithu@mail.com"),"HIGH"
//        ));
//
//        //5
//        taskService.createTask(new Task(
...
//                today.minusDays(5),today.minusDays(5),
//                false,
//                userService.getUserByEmail("manager@mail.com").getName(),
//                userService.getUserByEmail("kaushik@mail.com"),"HIGH"
//        ));
//
//        //6
//        taskService.createTask(new Task(
...
//                today.minusDays(2),today.minusDays(4),
//                false,
//                userService.getUserByEmail("manager@mail.com").getName(),
//                userService.getUserByEmail("laxmi@mail.com"),"LOW"
//        ));
//
//        //7
//        taskService.createTask(new Task(
...
//                today.minusDays(1),today.minusDays(4),
//                false,
//                userService.getUserByEmail("manager@mail.com").getName(),
//                userService.getUserByEmail("teja@mail.com"),"HIGH"
//        ));
//
//        //8
//        taskService.createTask(new Task(
...
//                false,
//                userService.getUserByEmail("manager@mail.com").getName(),
//                userService.getUserByEmail("vaishu@mail.com"),"HIGH"
//        ));
//
//        //9
//        taskService.createTask(new Task(
...
//                false,
//                userService.getUserByEmail("kaushik@mail.com").getName(),
//                userService.getUserByEmail("kaushik@mail.com"),"HIGH"
//        ));
//
//        //14
...
//                today.plusDays(6),today,
//                false,
//                userService.getUserByEmail("manager@mail.com").getName(),
//                userService.getUserByEmail("manager@mail.com"),"HIGH"
//        ));
//
//        //15
//        taskService.createTask(new Task(
...
//                today.plusDays(8),today,
//                false,
//                userService.getUserByEmail("manager@mail.com").getName(),"LOW"
//        ));
//
//        //16
//        taskService.createTask(new Task(
...
//                today.plusDays(10),today,
//                false,
//                userService.getUserByEmail("manager@mail.com").getName(),"MEDIUM"
//        ));
//
//        //17
//        taskService.createTask(new Task(
...
//                today.plusDays(12),today,
//                false,
//                userService.getUserByEmail("manager@mail.com").getName(),"HIGH"
//        ));
//
//        //18
//        taskService.createTask(new Task(
